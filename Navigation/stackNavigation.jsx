...
//   return (
//     <NavigationContainer>
//       <Stack.Navigator screenOptions={{ headerShown: false }} initialRouteName="boards">
//         {/* Onboarding then direct to BottomNav */}
//         <Stack.Screen name="boards" component={Onboarding} />
...
//         {/* Auth Screens (still here in case you reuse later) */}
//         <Stack.Screen name="login" component={Login} />
//         <Stack.Screen name="register" component={Register} />
//         <Stack.Screen name="forgot" component={Forgot} />
//       </Stack.Navigator>
