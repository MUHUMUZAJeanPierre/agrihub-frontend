        ...
        <View style={styles.headerContent}>
          <View style={styles.headerLeft}>
            <Text style={[styles.headerTitle, { color: Colors.text }]}>
              {username ? `${username}'s Dashboard` : 'Agronomist Dashboard'}
            </Text>
          </View>
            ...
            >
              ...
              >
                <View style={[styles.profileModalContent, { backgroundColor: Colors.modalBackground, borderColor: Colors.border }]}>
                  <Text style={[styles.modalTitle, { color: Colors.text }]}>Profile Options</Text>
                  ...
                  >
                    <View style={styles.toggleButtonContent}>
                      ...
                      <Text style={[styles.toggleButtonText, { color: Colors.textPrimary }]}>
                        {language === 'en' ? 'Change to Kinyarwanda' : 'Change to English'}
                      </Text>
                    </View>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity
                    style={[styles.toggleButton, { backgroundColor: Colors.surface, borderColor: Colors.border }]}
                  >
                    <Text style={[styles.toggleButtonText, { color: Colors.textPrimary }]}>Logout</Text>
                  </TouchableOpacity>
